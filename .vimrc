...
" vim-plug plugin manager -  autoinstallation
...
"vim-wordmotion plugin
"makes vim recognize separate words written in CamelCase and snake_case 
...
"" load riv project paths TODO: Fix this.
"" source ~/.riv/riv.projects.vim
